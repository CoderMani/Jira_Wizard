...
def categorize_bug_resolution(value, status):
    ...
    nad = ["Not a defect - As designed", "Need More Information", "Not Our Defect", "Not a Defect", "Not Our Defect", "Feature Dropped", "Not a Defect: Other", "Not a Defect: As Designed", "Not a Defect: App/OS Error", "Not a Defect: Feature Not Ready", "Not a Defect: Design Limitation"]
